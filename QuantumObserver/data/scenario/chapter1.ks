...
[font color="0xddbb88" bold="true"]御厨『ロマ男君。検出器を切りたまえ。画面を見てはいけない』[p]
[font color="0xe8f6ff" bold="false"]
...
[eval exp="quantumPhone.receive('c1_self','ロマ男','三つの通知のうち、一つは死んだ僕が送った。どれかは僕にも分からない。','02:13',false)"]
